package com.rafaelsantos.uri2621.repositories;
...
import com.rafaelsantos.uri2621.entities.Product;
...
public interface ProductRepository extends JpaRepository<Product, Long>{
	...
	@Query("SELECT new com.rafaelsantos.uri2621.dto.ProductMinDTO(obj.name) "
			+ "FROM Product obj "
